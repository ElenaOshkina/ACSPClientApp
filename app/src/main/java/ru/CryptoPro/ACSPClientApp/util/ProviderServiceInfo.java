...
import ru.CryptoPro.ACSPClientApp.MainActivity;
...
public class ProviderServiceInfo {
    ...
    /**
     * Вывод списка доступных контейнеров для данного
     * провайдера {@link ru.CryptoPro.ACSPClientApp.MainActivity#defaultKeyStoreProvider}.
     *
     * @param callback Поле для вывода информации.
     */
    public static void logKeyStoreInfo(LogCallback callback) {
        logKeyStoreInfo(callback, MainActivity.getDefaultKeyStoreProvider());
    }
