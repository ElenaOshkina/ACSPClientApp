/**
 * $RCSfileHttpTLSSimpleExample.java,v $
 * version $Revision: 36379 $
 * created 02.12.2014 15:45 by Yevgeniy
 ...
 * по TLS 1.0 с помощью apache http client с односторонней
 * аутентификацией.
 *
 * @author Copyright 2004-2014 Crypto-Pro. All rights reserved.
 * @.Version
 */
public class HttpTLSSimpleExample extends HttpTLSExample {
     ...
     */
    public HttpTLSSimpleExample(ContainerAdapter adapter) {
        super(adapter);
    }
