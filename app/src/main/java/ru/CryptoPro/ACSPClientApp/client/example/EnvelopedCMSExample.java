/**
 * $RCSfileEnvelopedCMSExample.java,v $
 * version $Revision: 36379 $
 * created 19.02.2015 13:51 by afevma
...
public class EnvelopedCMSExample extends IEncryptDecryptData {
    ...
    private void encryptDecrypt(LogCallback callback) throws Exception {
        ...
        load(askPinInDialog, keyStoreType, containerAdapter.getServerAlias(),
        ...
        cmsSign.load(askPinInDialog, keyStoreType, containerAdapter.getClientAlias(),
        ...
        // Проверяем расшифрованную CMS подпись.
        cmsSign.verify(callback, decryptedCms, new Certificate[]
            {cmsSign.getCertificate()}, null);
