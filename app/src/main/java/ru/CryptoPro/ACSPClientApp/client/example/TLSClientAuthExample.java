/**
 * $RCSfileTLSClientAuthExample.java,v $
...
/**
 * Класс TLSClientAuthExample реализует пример обмена
 * по TLS 1.0 двухсторонней аутентификацией.
 *
 * @author Copyright 2004-2014 Crypto-Pro. All rights reserved.
 * @.Version
 */
public class TLSClientAuthExample extends TLSExample {
     ...
     */
    public TLSClientAuthExample(ContainerAdapter adapter) {
        super(adapter);
    }
